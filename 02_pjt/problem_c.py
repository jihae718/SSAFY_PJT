...
#     rate_lst.append(i['vote_average'])
#   rate_lst1 = sorted(rate_lst, reverse=True)
#   movie_lst = []
#   for i in rate_lst1[:5]:
#     for j in response['results']:
#       if j['vote_average']==i:
#         movie_lst.append(j['id'])
#   movie_lst1=[]
#   for i in range(len(movie_lst)):
#     if movie_lst[i] not in movie_lst[:i]:
#       movie_lst1.append(movie_lst[i])      
#   result=[]
#   for i in movie_lst1:
#     for j in response['results']:
#       if i == j['id']:
